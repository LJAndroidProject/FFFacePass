...
public class CameraFragment extends BaseFragment implements CameraDialog.CameraDialogParent {
            ...
            if(intent != null) {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        toast.setView(imageView);   //  把定义好的View布局设置到Toast里面
                        toast.show();
                    }
                });
    ...
    private void captureByDoor(int doorNumber,long time,long bin_id){
        Log.i(CAMERA_TAG,"拍摄" + doorNumber + "桶位" + bin_id);
    ...
    private void resultSecondCamera() {
        ...
        mHandlerSecond = UVCCameraHandler.createHandler(getActivity(), mUVCCameraViewSecond, UVCCamera.DEFAULT_PREVIEW_WIDTH, UVCCamera.DEFAULT_PREVIEW_HEIGHT, BANDWIDTH_FACTORS[1]);
    }
    ...
    private void resultThirdCamera() {
        ...
        mHandlerThird = UVCCameraHandler.createHandler(getActivity(), mUVCCameraViewThird, UVCCamera.DEFAULT_PREVIEW_WIDTH, UVCCamera.DEFAULT_PREVIEW_HEIGHT, BANDWIDTH_FACTORS[1]);
    }
    ...
    private void resultFourthCamera() {
        ...
        mHandlerFourth = UVCCameraHandler.createHandler(getActivity(), mUVCCameraViewFourth, UVCCamera.DEFAULT_PREVIEW_WIDTH, UVCCamera.DEFAULT_PREVIEW_HEIGHT, BANDWIDTH_FACTORS[1]);
    }
    ...
    private void resultFifThCamrea() {
        ...
        mHandlerFifth = UVCCameraHandler.createHandler(getActivity(), mUVCCameraViewFifth, UVCCamera.DEFAULT_PREVIEW_WIDTH, UVCCamera.DEFAULT_PREVIEW_HEIGHT, BANDWIDTH_FACTORS[1]);
    }
    ...
    private void resultSixthCamera() {
        ...
        mHandlerSixth = UVCCameraHandler.createHandler(getActivity(), mUVCCameraViewSixth, UVCCamera.DEFAULT_PREVIEW_WIDTH, UVCCamera.DEFAULT_PREVIEW_HEIGHT, BANDWIDTH_FACTORS[1]);
    }
    ...
    private final OnDeviceConnectListener mOnDeviceConnectListener = new OnDeviceConnectListener() {
        ...
        public void onAttach(final UsbDevice device) {
            if (DEBUG) Log.v(TAG, "onAttach:" + device.getProductId());
